...
"""
class Node:
    def __init__(self, label, temperature=300.0, is_boundary=False, heat_input=0.0, material=None, mass=1e-8):
        """
        ...
        self.mass = mass
    def __repr__(self):
        return f"Node(label={self.label}, T={self.temperature:.2f}K, Q={self.heat_input:.3e}W, material={self.material}, mass={self.mass})"
